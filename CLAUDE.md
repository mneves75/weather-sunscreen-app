...
**Current Version:** 1.3.1 (Expo SDK 54, iOS 26 support, New Architecture enabled, Jest testing infrastructure, react-doctor 100/100; versioned on the active 1.x line — the `v3.x` git tags are from an earlier experimental line)
