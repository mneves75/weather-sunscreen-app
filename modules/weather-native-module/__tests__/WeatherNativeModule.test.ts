...
describe('WeatherNativeModule', () => {
  ...
  describe('getWeatherData', () => {
    ...
    it('should handle WeatherKit unavailable', async () => {
      mockWeatherModule.getWeatherData.mockRejectedValue(
        new Error('WeatherKit not available')
      );
  ...
  describe('calculateUVIndex', () => {
    ...
    it('should handle calculation errors', async () => {
      mockWeatherModule.calculateUVIndex.mockRejectedValue(
        new Error('UV calculation failed')
      );
  ...
  describe('clearWeatherCache', () => {
    ...
    it('should handle cache clearing errors', async () => {
      mockWeatherModule.clearWeatherCache.mockRejectedValue(
  ...
  describe('Performance', () => {
    ...
    it('should throttle location updates appropriately', async () => {
      ...
      const promises = Array(10).fill(null).map(() => 
        WeatherNativeService.getCurrentLocation()
      );
