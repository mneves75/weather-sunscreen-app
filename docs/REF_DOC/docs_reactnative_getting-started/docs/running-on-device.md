...
reverse](/docs/running-on-device#method-1-using-adb-reverse-recommended).
...
You can now enable Fast Refresh from the [Dev Menu](/docs/debugging#opening-
the-dev-menu). Your app will reload whenever your JavaScript code has changed.
...
**Network**.
  ...
  3. You'll see a [red screen with an error](/docs/debugging#logbox). This is OK. The following steps will fix that.
  4. Open the in-app [Dev Menu](/docs/debugging#opening-the-dev-menu).
...
the guide for [generating a signed APK](/docs/signed-apk-android) to learn
more.
...
to open the [Dev Menu](/docs/debugging#opening-the-dev-menu), then enable Fast
...
with an error](/docs/debugging#logbox) saying:
...
guide for [publishing to the Apple App Store](/docs/publishing-to-app-store)
to learn more.

info

A Mac is required in order to build your app for iOS devices. Alternatively,
you can refer to our [environment setup guide](/docs/environment-setup) to
learn how to build your app using Expo CLI, which will allow you to run your
...
website/edit/main/docs/running-on-device.md)[Edit page for current
release](https://github.com/facebook/react-native-
website/edit/main/website/versioned_docs/version-0.81/running-on-device.md)

Last updated on **Aug 20, 2025**

[ PreviousOut-of-Tree Platforms](/docs/out-of-tree-platforms)[NextFast
Refresh](/docs/fast-refresh)
