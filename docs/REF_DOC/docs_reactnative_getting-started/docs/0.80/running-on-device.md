...
> reverse](/docs/0.80/running-on-device#method-1-using-adb-reverse-
> recommended).

> Hint: You can also use the `React Native CLI` to generate and run a
> `release` build (e.g. from the root of your project: `yarn android --mode
> release`).
...
Menu](/docs/0.80/debugging#opening-the-dev-menu). Your app will reload
...
**Network**.
  ...
  3. You'll see a [red screen with an error](/docs/0.80/debugging#logbox). This is OK. The following steps will fix that.
  4. Open the in-app [Dev Menu](/docs/0.80/debugging#opening-the-dev-menu).
...
the guide for [generating a signed APK](/docs/0.80/signed-apk-android) to
learn more.
...
> If you run into any issues, please take a look at Apple's [Launching Your
> App on a
...
to open the [Dev Menu](/docs/0.80/debugging#opening-the-dev-menu), then enable
...
> network. You may use your device's Personal Hotspot feature in this case.
> You may also share your internet (Wi-Fi/Ethernet) connection from your Mac
> to your device via USB and connect to the bundler through this tunnel for
> very high transfer speeds.

When trying to connect to the development server you might get a [red screen
with an error](/docs/0.80/debugging#logbox) saying:
...
guide for [publishing to the Apple App Store](/docs/0.80/publishing-to-app-
store) to learn more.

> A Mac is required in order to build your app for iOS devices. Alternatively,
> you can refer to our [environment setup guide](/docs/0.80/environment-setup)
...
website/edit/main/docs/running-on-device.md)[Edit page for 0.80
release](https://github.com/facebook/react-native-
website/edit/main/website/versioned_docs/version-0.80/running-on-device.md)

Last updated on **Jun 17, 2025**

[ PreviousOut-of-Tree Platforms](/docs/0.80/out-of-tree-platforms)[NextFast
Refresh](/docs/0.80/fast-refresh)
