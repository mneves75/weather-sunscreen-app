[AI SDK UI](/docs/ai-sdk-ui)Chatbot
...
For more complex scenarios like message regeneration, you can use trigger-
based routing:
...
With `streamText`, you can control how error messages and usage information
