...
## [Create a build configuration file for
...
You can dramatically accelerate the remote building process by configuring
...
You can also copy your project contents manually using `rsync` or `scp` to the
