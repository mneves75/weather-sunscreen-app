...
[App Store Connect](/help/app-store-connect/) / Getting paid / View payments
and proceeds
...
Payments and Financial Reports displays a summary of your proceeds for the
current fiscal month, and information on sales of your apps and in-app
purchases.

You can also view detailed information for each country or region, such as the
number of units sold, the amount earned in that country’s or region's
currencies, taxes, and adjustments, the exchange rate applied to the payment,
and the total proceeds owed to you displayed in the currency of your bank
account.

Proceeds are the amount you'll receive on sales of your apps and in-app
purchases. This is the Customer Price minus applicable taxes and Apple’s
commission, per Schedule 2 of your Paid Apps Agreement.

Payment information for the previous fiscal month appears in Payments and
Financial Reports starting the first Wednesday of the current fiscal month.
Data continues to populate until financial reports are ready for all countries
or regions by the first Friday of the current fiscal month.

![Screenshot of sample payments and proceeds.](/help/app-store-
connect/getting-paid/view-payments-and-
proceeds/images/ViewPaymentsandProceeds-1_2x.png)

**Required role:** Account Holder, Admin, or Finance. [View role
permissions.](/help/app-store-connect/reference/role-permissions)

### View payments and estimated proceeds

At the top of the page, either your total estimated proceeds, or the amount
paid for that period will display. The amount displayed depends on the month
selected, and whether payment for that month has been received.
...
The date shown indicates when the payment was issued. There is also a
Transaction ID, a unique seven-digit payment reference number. This may also
be referred to as a Consolidated Credit Identifier (CCI). The CCI number is
included as a reference in the additional text provided with the payment
transfer details to your bank. If you have questions about a payment, it’s
helpful to have the CCI number available when you contact Apple.
...
Estimated proceeds may display if one of the following has occurred:
  ...
  * **Balance Carried Forward.**[Minimum payment threshold](/help/app-store-connect/reference/minimum-payment-threshold) has not yet been met, meaning your proceeds will carry over to the next payment period.
...
### View a previous month’s proceeds
  ...
  1. In the [homepage](https://appstoreconnect.apple.com/), click Payments and Financial Reports.

  2. In the center, click the month.

  3. In the pop-up menu, use the arrows to select a month.

![View previous month’s proceeds](/help/app-store-connect/getting-paid/view-
payments-and-proceeds/images/ViewPaymentsandProceeds-2_2x.png)

### View your vendor number

You can view your Vendor Number at any time in App Store Connect. Vendor
Numbers are needed for downloading reports using the App Store Connect API.

  1. In the [homepage](https://appstoreconnect.apple.com/), click Payments and Financial Reports.

  2. Your Vendor Number appears in the top left hand corner under your Legal Entity Name.

![Screenshot of the Payments and Financial Reports page, with the 'Example
Company 1' dropdown menu open at the top left, revealing 'Example Company 1'
and 'Vendor # 1234567'.](/help/app-store-connect/getting-paid/view-payments-
and-proceeds/images/ViewPaymentsandProceeds-3_2x.png)

**Important:** The payment amount shown in App Store Connect represents the
amount we've sent to your bank. However, the amount you receive may vary
depending on bank fees and transaction costs deducted by your bank or
intermediate financial institutions. [Learn more.](/help/app-store-
connect/measure-app-performance/overview-of-reporting-tools)

### View proceeds from a different legal entity name or vendor number

The menu at the top left lists legal entity names and associated vendor
numbers or revenue streams that have been reported to or paid.

Multiple vendor numbers appearing in the menu indicates that more than one
legal entity or revenue stream has been associated with your App Store Connect
account. There may be a few reasons why multiple vendor numbers are listed:
...
To view proceeds from a different legal entity name or vendor number:
  ...
  2. On the top left, click the arrow next to your vendor name.

  3. Choose from the pop-up menu to view reports for other legal entities. When selecting a vendor number from the menu, the page will update to reflect the financial activity of the assigned entity.

### Resolve a returned payment error

If your bank returns a payment to us, we’ll show you an alert where your
proceeds are displayed and also on the App Store Connect homepage, along with
the reason the payment was returned, and the bank reference number. You can
also [opt in to receive email notifications](/help/app-store-connect/manage-
your-team/view-and-edit-your-profile#set-email-notifications) for returned
payments.

Payment Returned alerts will include the following:

  * **Reason.** This explains the reasons why your payment may be returned. If our bank lacks specific information regarding the return, we’ll provide any details received from your bank.

  * **Required Adjustment.** This includes information on how to fix the problem, or information you’ll need to know to follow up with your bank.

You can often resolve this issue by [updating your banking
information](/help/app-store-connect/manage-banking-information/enter-banking-
information) in the Business section. If Payment Returned alerts persist after
verifying your banking details, please contact your bank to resolve this
issue.
...
Once you make all necessary updates, payments should resume within two
regularly scheduled payment cycles. Returned and held earnings may take up to
two payment cycles to resend with a regularly scheduled payment, and will be
identified in the Balance column of that payment breakdown. The Payment
Returned alert will display until the issue is resolved and we’re able to
successfully make a payment to you.

If you've confirmed that your bank account information in App Store Connect is
correct, reach out to your bank to resolve why they're not accepting our
payments. Use the Transaction ID presented to assist your bank in locating the
returned payment.

**Related** [Payment information](/help/app-store-connect/reference/payment-
information)
