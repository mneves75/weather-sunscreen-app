...
The system provides several variants of the button title. Depending on the
...
If your interface requires it, you can create a custom Sign in with Apple
...
Use only the logo artwork downloaded from [Apple Design
